...
class BindingAdapter {
    ...
    companion object{
        ...
        fun parsePriorityColor(imageView : ImageView, priority: Priority){
            when(priority){
                Priority.HIGH ->{ imageView.setImageDrawable(imageView.context.getDrawable(R.drawable.pink))}
                Priority.MEDIUM ->{ imageView.setImageDrawable(imageView.context.getDrawable(R.drawable.blue))}
